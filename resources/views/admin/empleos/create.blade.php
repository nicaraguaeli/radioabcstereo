...
<form action="{{route('empleo.store')}}" method="post" enctype="multipart/form-data">
@csrf
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <div class="container">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input required name="cargo" type="text" class="form-control" id="inputEmail3">
                    </div>
                  </div>
                   <div class="form-group row">
                ...
                <textarea name="descripcion" class="textarea" placeholder="Escribe tu nota aqui"
                 ...
                 <div class="row justify-items-between">
                   ...
                   <div class="col-lg-6 form-group"> <a href="{{url('admin')}}" type="submit" class="btn btn-info">Cancelar</a></div>
                    <div class="col-lg-6 form-group"> <button type="submit" class="btn btn-primary">Publicar Empleo</button></div>
                 </div>
                </div>
