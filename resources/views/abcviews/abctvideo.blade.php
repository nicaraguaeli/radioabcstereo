...
<div class="container mb-5">
  ...
  <div class="d-flex mt-5 ">
    ...
    <div>
      <h4 class="h6 ml-2">ABC</h4>
    </div><i class="fas fa-caret-right ml-2" style="font-size: 17px;"></i>
    <div>
      <h4 class="h6 font-weight-bold  ml-2 wow fadeInUp text-uppercase" data-wow-delay="0.2s">tv</h4>
    </div>
    <i class="fas fa-caret-right ml-2" style="font-size: 17px;"></i>
    <div>
      <h4 class="h6 font-weight-bold  ml-2  text-uppercase">{{$video->tipo}}</h4>
    </div>
  ...
  <div class="d-flex">
    <div class="mr-2">
      <div class="fb-share-button" data-href="http://www.radioabcstereo.com/abctvsearch/{{$video->id}}_{{Str::slug($video->titulo,'-')}}" data-layout="button_count">
      </div>
    </div>
    <div class="mr-2">
    ...
    <div class="mr-2"><a style="border-radius: 3px;" class="badge-info text-white pl-2 pr-2 bg-dark" href="mailto:?subject=Noticia&amp;body=Noticia ABC http://www.radioabcstereo.com/abctvsearch/{{$video->id}}_{{Str::slug($video->titulo,'-')}}" title="Compartir por correo">
