     ...
     <section >
      ...
      <div class="row mt-2 ">
        <div class="col-lg-9 align-self-center">
          ...
          <img class="img-fluid" src="{{asset(''.$nota->Imagen)}}" alt="{{$nota->referencia}}">
          <h6 class="text-center"><i>{{$nota->referencia}}</i></h6>
     ...
     <div class="col-lg-9">
         ...
         @foreach($noticiasRam as $ram)
          ...
          <div class="row gris mb-2 wow fadeIn" data-wow-delay="0.2s" >
            ...
            <div class="col-sm-3"> <img height="100" src="{{$ram->Imagen}}" alt=""></div>
